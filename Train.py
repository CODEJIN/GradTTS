...
from Modules.Modules import GradTTS, Mask_Generate, MLE_Loss
...
class Trainer:
    ...
    def Model_Generate(self):
        self.model = GradTTS(self.hp).to(self.device)
        self.criterion_dict = {
    ...
    def Evaluation_Epoch(self):
        ...
        if self.gpu_id == 0:
            ...
            prediction_feature = (predictions[:, :, :feature_lengths[index]] + 1.0) / 2.0 * (self.feature_max - self.feature_min) + self.feature_min
